...
sidebar:
  label: Introduction
  order: 1
slug: computer-organization-and-digital-design/introduction
prev: false
next: true
---
...
Analog devices and systems have time-varying signals that take continuous ranges
of values. Digital devices and systems are an abstracted version of analog
systems with finitely many discrete states. 2 states are commonly used: HIGH (1)
and LOW (0).

### Comparison

- Reproducibility of results - digital is better, because in analog,
  inteferences would cause errors
